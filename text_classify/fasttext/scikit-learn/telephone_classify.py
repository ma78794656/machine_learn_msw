...
if __name__ == '__main__':
    ...
    thresh = 0.5
    model_save_file = r'/data/code/github/machine_learn_msw/text_classify/fasttext/scikit-learn/telephone_models'
    model_save = {}
 ...
 '退回': True}
    ...
    for name, model in model_save.items():
        ...
        predicted_list = sorted(p2._prob_dict.items(), key=lambda d: d[1], reverse=True)
        print(p1)
